      ...
      <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="flex items-center flex-col md:flex-row justify-between">
          ...
          <ul className="flex flex-wrap items-center mb-2 text-sm font-medium text-gray-500">
            ...
            <li>
              <a href="https://www.linkedin.com/in/debjani-dey-4981281ab/" target='_blank' rel='noreferrer' className="hover:underline">Contact</a>
            </li>
          </ul>
        </div>
        <hr className="my-6 sm:mx-auto border-[#282727] lg:my-8" />
        <span className="block text-sm text-gray-500 text-center dark:text-gray-400">
          Crafted By <a href="https://www.linkedin.com/in/debjani-dey-4981281ab/" rel='noreferrer' target='_blank' className="text-white hover:underline">Ruhi</a>
        </span>
      </div>
    </footer>
  )
