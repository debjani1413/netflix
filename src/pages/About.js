...
const About = () => {
  return (
    <div className='about-us mt-[70px] px-4 md:px-24'>
      <h1 className='text-5xl text-white text-center mb-4 font-bold'>About Netflix</h1>
      <p className='text-gray-400 mb-8 text-center'>
        "Experience Netflix: A Feature-Rich, Mobile-Friendly Netflix Clone with Cutting-Edge Tech Stack! 🚀
        <br />
        <br />
        Dive into the world of Netflix, a carefully crafted Netflix clone that boasts an impressive tech stack including React, Redux, Webpack, React Router, TMDB APIs, Tailwind CSS, Firebase, React-DOM.
        The result? An exceptional web application designed for optimal performance and seamless user interactions.

        Netflix is fully optimized to ensure lightning-fast load times and a smooth user experience, making it perfect for both desktop and mobile devices. Discover a user-friendly interface that offers an immersive viewing experience, all in the palm of your hand.
        <br />
        <br />
        Join me in the future of web development, where innovation and user-centric design converge to create Netflix—a showcase of what's possible in the realm of entertainment.
      </p>

      <div className='mb-8 text-gray-200'>
        Github: <a href='https://github.com/debjani1413' className='hover:text-blue-700 ml-3 text-blue-600 text-sm' target='_blank' rel='noreferrer'>Netflix</a>
        <br />
        ...
        <br></br>
        Linkedin: <a href='https://www.linkedin.com/in/debjani-dey-4981281ab/' className='hover:text-blue-700 ml-3 text-blue-600 text-sm' target='_blank' rel='noreferrer'>Ruhi</a>
      </div>
